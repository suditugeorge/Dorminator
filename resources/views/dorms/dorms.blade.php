            ...
            <div class="container">
                ...
                <form>
                    ...
                    <div class="md-form">
                        ...
                        <textarea type="text" class="md-textarea" style="height: 100px ;resize: vertical;" id="dorm-description"></textarea>
                        <label for="dorm-description">Descriere cămin</label>
                    </div>

                    <div class="text-center">
                        <button class="btn btn-unique" id="send-dorm">Adaugă cămin <i class="fa fa-paper-plane-o ml-1"></i></button>
                    </div>
                                            ...
                                            <table class="table">
                                                ...
                                                @foreach ($dorms as $dorm)
                                                    <tr>
                                                        ...
                                                        <td>{{$dorm->code}}</td>
                                                        <td>
                                                            <a class="red-text" href="/delete-dorm/{{$dorm->id}}"><i class="fa fa-times"></i></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
